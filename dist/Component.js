sap.ui.define([
	...
	"sap/ui/Device",
	"empinfo28/model/models",
	"empinfo28/controller/ListSelector",
	"empinfo28/controller/ErrorHandler",
	"empinfo28/model/formatter"
], function(UIComponent, Device, models, ListSelector, ErrorHandler) {
	"use strict";

	return UIComponent.extend("empinfo28.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "empinfo28.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "empinfo28.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/sap/ZEMPLOYEE_INFORMATION_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				...
				"routes": [{
					...
					"pattern": "EmployeeHeaderSet/{objectId}",
					"name": "object",
